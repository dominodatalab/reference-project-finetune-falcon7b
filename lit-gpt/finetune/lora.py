...
#     fabric = L.Fabric(accelerator="cuda", devices=4, strategy="ddp", precision=precision, loggers=[])
...
def main(fabric: L.Fabric, data_dir: Path, checkpoint_dir: Path, out_dir: Path):
    ...
    save_path = out_dir / "lit_model_lora_finetuned_instruct.pth"
...
def validate(
    ...
    sample = {"instruction": instruction, "response": "", "context":""}
